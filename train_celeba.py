...
from celeba_dataset import create_celeba_dataloaders
...
def parse_args():
    ...
    parser.add_argument("--attr_emb_dim", type=int, default=128,
...
def generate_samples(model, attr_dict, device, num_samples=8, image_size=(64, 64)):
    ...
    with torch.no_grad():
        ...
        attribute_sets = {
            "smiling_female": {"Smiling": 1, "Male": 0},
            "serious_male": {"Smiling": 0, "Male": 1},
            "young_blonde": {"Young": 1, "Blond_Hair": 1},
            "glasses_beard": {"Eyeglasses": 1, "Goatee": 1},
        }
...
def main():
    ...
    num_attributes = dataloaders["num_attributes"]
